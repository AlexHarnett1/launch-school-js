...
//   let sortedTerrain = terrain.toSorted((a, b) => a - b);
//   return terrain.indexOf(sortedTerrain[sortedTerrain.length - 1]);
// }
...
function findPeakInTerrain(terrain) {
  ...
  while (left < right) {
    ...
    if (terrain[mid + 1] < terrain[mid] && terrain[mid - 1] < terrain[mid]) {
      return mid;
