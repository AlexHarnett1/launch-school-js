/*
Create a Book class with private fields title, author, and year. Provide getters for 
each field and a setter for the year field that raises a RangeError if year is before 1900.
*/
...
class Book {
  ...
  set year(year) {
    if (year < 1900) {
      throw new RangeError('Year must be after 1900.');
    } else {
      this.#year = year;
    }
  }
